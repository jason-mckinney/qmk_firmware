...
#define DISABLE_RGB_MATRIX_PINWHEEL_SAT
#define DISABLE_RGB_MATRIX_PINWHEEL_VAL
...
#define DISABLE_RGB_MATRIX_PINWHEEL
#define DISABLE_RGB_MATRIX_SPIRAL
